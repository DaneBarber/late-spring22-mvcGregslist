...
class AppState extends EventEmitter {
  ...
  jobs = [
    new Job({ title: 'Chevrolet', model: 'Impala', description: 'It balla', price: 10, year: 1964, color: '#000', imgUrl: 'https://m.media-amazon.com/images/I/51IpgyJ3GmL._AC_SX466_.jpg' }),
  ]
}
